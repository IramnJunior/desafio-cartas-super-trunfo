...
int main() {
    ...
    // Calculando densidade e PIB per capita (PIB em bilhões -> reais)
    densidade1 = populacao1 / area1;
    pibPerCapita1 = (pib1 * 1000000000) / populacao1;
    densidade2 = populacao2 / area2;
    pibPerCapita2 = (pib2 * 1000000000) / populacao2;

    // Calculando Super Poder (float). 
    // Fórmula: população + área + PIB + pontos turísticos + PIB per capita + (1 / densidade)
